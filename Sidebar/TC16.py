...
#mencari elemen menggunakan path dengan elemen span dan dengan text "Settings" di lanjutkan dengan aksi clik/tekan
driver.find_element(By.XPATH, "//span[text()='Settings']").click()

#mencari elemen menggunakan path dengan elemen span dan dengan text "settings_profile" di lanjutkan dengan aksi clik/tekan
driver.find_element(By.XPATH, "//span[text()='settings_profile']").click()
...
#mencari elemen menggunakan path dengan elemen span dan dengan text "Dashboard" di lanjutkan dengan aksi clik/tekan
