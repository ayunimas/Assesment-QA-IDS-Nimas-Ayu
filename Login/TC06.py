...
#mencari elemen menggunakan link text "Sign up here" (link yg berbentuk teks) dan memberi aksi clik/tekan
driver.find_element(By.LINK_TEXT, "Sign up here").click()

#menutup halaman website
driver.quit() #di aktifin biar tau kalo uda click dan ngga ngarah ke sign up page alias bug