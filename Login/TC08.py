...
#mencari elemen menggunakan path dengan elemen div, dan atribut role=combobox di lanjutkan dengan aksi clik/tekan
driver.find_element(By.XPATH, "//div[@role='combobox']").click()

#mencari elemen menggunakan path dengan elemen li, dan atribut data-value=id di lanjutkan dengan aksi clik/tekan
driver.find_element(By.XPATH, "//li[@data-value='id']").click()

time.sleep(2) #memberi jeda

#mencari elemen menggunakan path dengan elemen div, dan atribut role=combobox di lanjutkan dengan aksi clik/tekan
driver.find_element(By.XPATH, "//div[@role='combobox']").click()

#mencari elemen menggunakan path dengan elemen li, dan atribut data-value=en di lanjutkan dengan aksi clik/tekan
driver.find_element(By.XPATH, "//li[@data-value='en']").click()
