...
#mencari elemen menggunakan link text "Reset" di lanjutkan dengan aksi clik/tekan
driver.find_element(By.LINK_TEXT, "Reset").click()

#mencari elemen menggunakan link text "Back to Login page" di lanjutkan dengan aksi clik/tekan
