...
#mencari elemen menggunakan link text "Rest" di lanjutkan dengan aksi clik/tekan
driver.find_element(By.LINK_TEXT, "Reset").click()

#mencari elemen menggunakan path dengan elemen button, dan atribut type=sumbit di lanjutkan dengan aksi clik/tekan
